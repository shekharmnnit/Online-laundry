...
<!-- header -->
	...
	<div class="w3-header-bottom">
		<div class="container"> 
				<h1><a href="index.php"><span class="letter">D</span>eterge<span class="square"></span></a></h1>	
			<div class="header-w3-top">
				<div class="agileinfo-phone">
				<div class="phone-wthree-left">
					
					<i class="fa fa-volume-control-phone" aria-hidden="true"></i>
					<p>Want a Launder...? <span>Order now!</span></p>
				</div>
				 <a href="" class="btn1-w3-agileits">Order now</a>
				</div>
			</div>
			<div class="top-nav">
		...
		<div class="container">
			<div class="footer-row w3layouts-agile">
				<div class="col-md-3 footer-grids w3l-agileits">
					<h6><a href="index.php"><span class="f-letter">D</span>eterge<span class="f-square"></span></a></h6>
				</div>
				<div class="col-md-3 footer-grids w3l-agileits">
					<h3>Address</h3>
					<p>3745 Noriega St,</p>
...
<!-- modal -->
	...
	<div class="modal about-modal w3-agileits fade" id="myModal3" tabindex="-1" role="dialog">
      ...
      <div class="form-group">
      <input class="form-control" type="number" placeholder="Phone no." name="phoneno" required />
      </div>
      <div class="form-group">
      <input class="form-control" type="email" placeholder="Email" name="email" required />
      </div>
